...
class CartController extends MobileBaseController {
    ...
    public function cart2()
    {
        ...
        $sql = "select c1.name,c1.money,c1.condition, c2.* from __PREFIX__coupon as c1 inner join __PREFIX__coupon_list as c2  on c2.cid = c1.id and c1.type in(0,1,2,3) and order_id = 0  where c2.uid = {$this->user_id} and NOW() < c1.use_end_time and c1.condition <= {$result['total_price']['total_fee']}";
