...
//    'LOAD_EXT_CONFIG'=>'db,route', // 加载数据库配置文件
    ...
    'URL_MODEL'=> 1 , // 如果需要 隐藏 index.php  打开这行"URL_MODEL"注释 同时在apache环境下 开启 伪静态模块，  如果在nginx 下需要另外配置，参考thinkphp官网手册
    /*
     * RBAC认证配置信息
     */
...
//     'REQUIRE_AUTH_ACTION'       => '',        // 默认需要认证操作
    ...
    'IMG_URL' => 'http://img.com/zhaoshiji/',
    'YOULIAO_ROOT'=> 'E:/oplinux/php_web/youliao/',
