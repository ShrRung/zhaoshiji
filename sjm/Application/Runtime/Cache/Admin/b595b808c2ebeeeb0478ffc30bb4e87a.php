...
<div class="wrapper">
  <header class="main-header">
      ...
      <a href="<?php echo U('Admin/Index/index');?>" class="logo">
        ...
        <span class="logo-lg"><img src="/Public/images/TP-shop_logo.png" width="40" height="30">&nbsp;&nbsp;<b>zhaoshiji.com</b></span>
      </a>
...
<section class="content-wrapper right-side" id="riframe" style="margin:0px;padding:0px;margin-left:230px;">
	...
	<footer class="main-footer">
	   ...
	   <strong>Copyright &copy; 2016-2026 <a href="http://www.zhaoshiji.com">有料信息科技（上海）有限公司</a>.</strong>保留所有权利。
	</footer>
