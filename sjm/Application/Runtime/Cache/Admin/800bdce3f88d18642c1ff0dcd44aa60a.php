				...
				<div class="panel-body">
					<div class="navbar navbar-default">
						<form action="" id="search-form2" class="navbar-form form-inline" method="post" onsubmit="return false">
							...
							<div class="form-group">
								<label class="control-label" for="input-order-id">自提点名称</label>
								<div class="input-group">
									<input type="text" name="key_word" value="" placeholder="自提点名称" id="input-order-id" class="form-control">
								</div>
							</div>
							<!--排序规则-->
							...
							<button type="button" onclick="location.href='<?php echo U('Admin/Pickup/add');?>'" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>添加自提点</button>
						</form>
					</div>
