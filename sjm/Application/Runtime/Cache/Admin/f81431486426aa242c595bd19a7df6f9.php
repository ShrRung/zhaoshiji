						...
						<form action="<?php echo U('Admin/Pickup/add');?>" method="post" onSubmit="return checkForm()">
							...
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td>
										<select class="di-bl fl seauii" name="suppliersid" id="suppliers_id">
											<option  value="0">不选则无供货商<?php echo ($pickup['suppliers_id']); ?></option>
											<?php if(is_array($suppliers)): $i = 0; $__LIST__ = $suppliers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i;?><option <?php if($pickup['suppliersid'] == $s['suppliers_id']): ?>selected="selected"<?php endif; ?>  value="<?php echo ($s["suppliers_id"]); ?>"><?php echo ($s["suppliers_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input class="wi80-BFB" type="text" name="pickup_contact" placeholder="自提点联系人" value="<?php echo ($pickup["pickup_contact"]); ?>"  maxlength="10"/></td>
								</tr>
								<tr>
