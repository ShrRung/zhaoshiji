    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover">
            ...
            <?php if(is_array($goodsList)): $i = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="text-right">
                        <a  target="_blank" href="/Goods/goodsInfo/id/<?php echo ($list['goods_id']); ?>" class="btn btn-info" title="查看详情"><i class="fa fa-eye"></i></a>
                        <a href="<?php echo U('Goods/addEditGoods',array('id'=>$list['goods_id']));?>" class="btn btn-primary" title="编辑"><i class="fa fa-pencil"></i></a>
