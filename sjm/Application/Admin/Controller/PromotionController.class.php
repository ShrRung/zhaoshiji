...
class PromotionController extends BaseController {
    ...
    public function group_buy_list(){
    	...
    	if($res){
    		foreach ($res as $val){
    			$val['start_time'] = substr($val['start_time'],0,10);
    			$val['end_time'] = substr($val['end_time'],0,10);
    			$list[] = $val;
    		}
    	}
    ...
    public function group_buy(){
    	...
    	if($groupbuy_id){
    		...
    		$group_info['start_time'] = substr($group_info['start_time'],0,10);
    		$group_info['end_time'] = substr($group_info['end_time'],0,10);
    		$act = 'edit';
    	}
    	$this->assign('min_date',date('Y-m-d'));
